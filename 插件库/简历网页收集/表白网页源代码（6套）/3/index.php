...
<img src='img/iali29.jpg' alt="一个人的游乐场"/>
	...
	<div class="write-tip">
		<span class="showtip">小提示：直接在网页上编辑，把小红小明删除替换为你的名字。</span>
	...
	<div class="write-ok">
		<div class="write-box">
			<h2>还差一步即可生成表白页面</h2>
			<p id="write-mp3">自定义背景音乐：<span id="text-music" contenteditable="true">http://<?php echo $_SERVER['HTTP_HOST']; ?>/yanshi/love/3/music/saveme</span><i></i>.mp3</p>
			<p id="write-url">自定义表白链接：<u>http://<?php echo $_SERVER['HTTP_HOST']; ?>/yanshi/biaobai/3/2016/</u><span id="text-href" contenteditable="true"><?php echo time(); ?></span><i></i><u>.html</u></p>
